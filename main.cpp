...
int main() {
    CircularArray<int>* array = new CircularArray<int>(7); // Array capacidad 7
    ...
    // ASSERT((*array)[1] == 15, "The operator [] push_front is not working");
    // ASSERT((*array)[7] == 7, "The operator [] push_front is not working");
